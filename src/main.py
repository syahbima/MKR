...
parser.add_argument('--lr_rs', type=float, default=1e-06, help='learning rate of RS task')
parser.add_argument('--lr_kge', type=float, default=1e-06, help='learning rate of KGE task')
