...
parser.add_argument('--lr_rs', type=float, default=6.25e-05, help='learning rate of RS task')
parser.add_argument('--lr_kge', type=float, default=6.25e-05, help='learning rate of KGE task')
